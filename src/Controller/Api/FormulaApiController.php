...
class FormulaApiController extends AbstractController
{
     ...
     * @return JsonResponse
     */
    public function getItem($id, FormulaRepository $repository, Ensure $ensure, Mapper $mapper)
    {
     ...
     * @return JsonResponse
     */
    public function duplicate(int $id, FormulaRepository $repository, Mapper $mapper)
    {
